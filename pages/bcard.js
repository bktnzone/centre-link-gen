              ...
              <div className="py-1 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7 mt-4">
                  ...
                  <div className="min-w-screen  flex items-center justify-center px-2 py-5">
                    <div className="w-full mx-auto border-4 rounded-lg bg-white shadow-lg px-5 pt-5 pb-5 text-gray-800">
                      ...
                      <div className="w-full h-auto m2" >
                        ...
                        {frameReady && (
                          <div className="relative py-3 sm:max-w-xl sm:mx-auto">
                            <div className="float-left   transform rotate-90">
                              <img width="65" src="/img/border-card-lime.png" />
                            </div>
                      ...
                      <div className="w-full mb-5">
                        ...
                        <p
                          className={`${
                            animateSlogan ? "animate-pulse" : ""
                          } text-md font-semibold text-gray-600 text-center px-5`}
                        >
                          {!frameReady && (
                            <>
                              <span className="text-xs font-normal">
                                Please stay in silence for a moment...
                              </span>
                              <span className="text-xs font-normal block">
                                Your card getting ready..
                              </span>
                            </>
                          )}
                        ...
                        {textCompleted && (
                          <div className="relative py-1 sm:max-w-xl sm:mx-auto -mt-5">
                            ...
                            <div className="float-right  transform -rotate-90">
                              <img width="65" src="/img/border-card-lime.png" />
                            </div>
                          </div>
                        )}
                    ...
                    <div className="-mt-3 min-w-screen  flex items-center justify-center px-3">
                      <div className="w-full mx-auto  bg-white shadow-lg px-2 p-1 text-gray-800">
                        <div className="flex justify-evenly">
                          <CopyToClipboard
                            onCopy={handleOnCopy}
                            text={cardInfo.disp_name + " " + cardInfo.slogan}
                          >
                            <span
                              className="cursor-pointer"
                              data-delay-hide="1000"
                              data-tip="copied slogan text to clipboard"
                              data-event="click"
                        ...
                        <div className="flex text-xs justify-evenly ">
                          <label className="hidden">share</label>
                          {!copied && <label>copy text</label>}
                          {copied && (
                            <label className="text-blue-600">copied</label>
                          )}
                ...
                <div class="content-center flex justify-center">
                  <audio id="maudio" controls>
                    <source src="/assets/avd-final.mp3" type="audio/mpeg" />
